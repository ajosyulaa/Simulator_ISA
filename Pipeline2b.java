...
class Pipeline2b {
    ...
    // static memory cache[][]= new memory[16][8];
    ...
    void decoder() {
        ...
        // System.out.println(st_arr1[0]+" x "+st_arr1[1]+" x "+st_arr1[2]+" x ");
        ...
        switch(codes[0]) {
            case 1:
                if(codes[3]==0)
                    ...
                    // System.out.println("register 1: "+reg1);
                }
                result=reg1;
                break;
            case 2:
    ...
    public static void main(String args[]) throws IOException {
        ...
        Pipeline2b[] obj = new Pipeline2b[st_arr.length];
        ...
        // cache[0][0].val=5;
        // cache[0][0].addr=0;
        obj[0].random_fill(100);

        int time=0;
        int a=0;
        // System.out.println("cv,ejrkjrnkrjv");
        // System.out.println("LOAD R5, [R3]".contains("[R"));
                ...
                if((timesteps[i][time-1]!=-1)&&(obj[i].completed[timesteps[i][time-1]])&&(obj[i].mem_stall==0)&&(obj[i].stall==0)) {
                    ...
                    switch(timesteps[i][time]) {
                        ...
                        case 1:
                                ...
                                if(((prev)>=0)&&(timesteps[prev][time]>=2)) {
                                    if(obj[i].codes[0]==1) {
                                        ...
                                        if((obj[i].codes[5]==1)&&((obj[prev].codes[0]<=4)&&((obj[prev].codes[1]==1)||(obj[prev].codes[1]==4)))&&(obj[i].codes[6]==obj[prev].codes[2])) {
                                            ...
                                            //         System.out.print(timesteps[i1][j1]+" ");
                                            //     }
                                            //     System.out.println();
                                            // }
                                            // System.out.println(prev+" gfcjtvjtjhb "+obj[i].stall);
                                        }
                                    }
                            ...
                            // System.out.println("cjtvjtjhb "+obj[i].stall);
                            if(obj[i].stall>0)
                                break;
                            // System.out.println(obj[i].stall+"did not break");
                        ...
                        case 4:
                            ...
                            if(((obj[i].codes[0]==5)||(obj[i].codes[0]==6)||(obj[i].codes[0]==8))&&(obj[i].result!=-1)) {
                                control_flag=1;
                                // System.out.println("control flag set");
                            }
            ...
            for(int i1=0;i1<st_arr.length;i1++) {
                for(int j1=0;j1<5;j1++) {
                    if(obj[i1].completed[j1]) {
                        count1++;
                        // System.out.print(obj[i1].completed[j1]+" ");
                    }
                }
                // System.out.println();
            }
